...
void TitleBar::initControl()
{
	...
	m_pIcon->setFixedHeight(TITLE_HEIGHT);
	...
	m_pButtonMin->setStyleSheet("border:none;background:none;");
	m_pButtonMax->setStyleSheet("border:none;background:none;");
	m_pButtonClose->setStyleSheet("border:none;background:none;");
	...
	vlay->addLayout(mylayout);
	vlay->addWidget(new QLabel());
	vlay->addStretch();
	vlay->setContentsMargins(5, 0, 0, 0);
	this->setLayout(vlay);
...
void TitleBar::setBackgroundColor(QColor color, bool isTransparent)
{
	m_color = color;
