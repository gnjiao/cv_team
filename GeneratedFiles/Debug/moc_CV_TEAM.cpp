...
QT_MOC_LITERAL(4, 68, 23), // "on_action_Help_triggerd"
QT_MOC_LITERAL(5, 92, 30), // "on_action_AboutCVTeam_triggerd"
QT_MOC_LITERAL(6, 123, 22) // "on_action_Get_triggerd"

    },
    "CV_TEAM\0on_action_Exit_triggered\0\0"
    "on_action_CameraSetting_triggered\0"
    "on_action_Help_triggerd\0"
    "on_action_AboutCVTeam_triggerd\0"
    "on_action_Get_triggerd"
};
...
void CV_TEAM::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_action_Help_triggerd(); break;
        case 3: _t->on_action_AboutCVTeam_triggerd(); break;
        case 4: _t->on_action_Get_triggerd(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
